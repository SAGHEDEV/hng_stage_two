    ...
    >
      ...
      <div className="bg-white p-8 lg:p-10 rounded-md z-20 self-center relative lg:left-[50%] lg:right-[50%] sm:w-80 md:w-96">
        ...
        <div className="flex justify-center gap-12 mt-4">
          <button
            className="border border-green-500 text-green-500 rounded-md px-12 py-3 hover:bg-green-500 hover:text-white font-bold text-2xl"
            onClick={() => {
              setShow(false), setStatusShow(true);
            }}
          >
            <BsCheck2 />
          </button>
