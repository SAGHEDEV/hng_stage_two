...
const Modal = ({ show, hideConfirm }) => {
  return (
    <div
      className={`w-[100vh] h-[100%] fixed top-0 left-0 right-0 bottom-0 flex justify-center items-center ${
        show ? "block" : "hidden"
      }`}
    >
      <div className="w-[100%] h-[100%] fixed top-0 left-0 right-0 bottom-0 bg-black/30"></div>
      <div className="bg-white p-10 rounded-md z-20 self-center relative left-[50%] right-[50%] ">
